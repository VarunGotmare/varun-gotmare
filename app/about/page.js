...
export default function AboutPage() {
      ...
      <main className="flex flex-col px-4 pt-24 pb-20 max-w-6xl mx-auto space-y-12">
        ...
        <section className="flex flex-col md:flex-row gap-10">
          ...
          <div className="flex-1 flex flex-col justify-start">
            <h1 className="text-4xl sm:text-5xl font-bold mb-4 mt-4">About Me</h1>
            <h1 className="text-4xl sm:text-33xl font-bold mb-4 mt-4">Tech Enthusiast, Problem Solver, and App Developer</h1>
  ...
  <p>
    Alongside app and web development, I’m deeply passionate about <strong>3D development and game design</strong>. Exploring tools like Blender and Unreal Engine allows me to create immersive digital experiences — something I’ve been fascinated by since my early days of tinkering with 3D art and environments.
  </p>
  <p>
